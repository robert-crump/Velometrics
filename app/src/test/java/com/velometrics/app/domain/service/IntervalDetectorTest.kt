...
class IntervalDetectorTest {
    ...
    // #178 — import-time HR recovery metrics (hrr60/hrr30/avgPower60sAfter/restBeforeNextIntervalSec)

    @Test
    fun `hrr60, hrr30, and avgPower60sAfter computed over the full window with enough trailing data`() {
